...
export const DEMO_PARAMETRES: ParametresCompte = {
  ...
  email_entreprise: 'contact@cleanpro-paris.fr',
  logo_url: null,
  signature_url: null,
  mentions_legales: "Auto-entrepreneur – TVA non applicable, art. 293 B du CGI. Sous réserve de disponibilité d'eau et d'électricité.",
...
export const DEMO_CLIENTS: Client[] = [
  {
    id: 'client-001', user_id: DEMO_USER_ID, type: 'particulier',
    nom: 'Marie Dupont', email: 'marie.dupont@gmail.com',
    telephone: '06 11 22 33 44',
    adresse: '12 rue de la Paix', ville: 'Paris', code_postal: '75001', country: 'France',
    ...
    first_name: 'Marie', last_name: 'Dupont', civility: 'Mme', is_canvassing: false,
    company_name: null, siren: null, siret: null, vat_number: null, legal_form: null, contact_name: null, service_address: null,
  },
  {
    id: 'client-002', user_id: DEMO_USER_ID, type: 'professionnel',
    nom: 'Cabinet Martin & Associés', email: 'contact@martin-avocats.fr',
    telephone: '01 42 33 44 55',
    adresse: '45 boulevard Haussmann', ville: 'Paris', code_postal: '75008', country: 'France',
    ...
    company_name: 'Cabinet Martin & Associés', siren: '78901234', siret: '78901234012345', vat_number: 'FR12789012340', legal_form: 'SARL', contact_name: 'Jean-Pierre Martin', service_address: null,
    first_name: null, last_name: null, civility: null, is_canvassing: false,
  },
  {
    id: 'client-003', user_id: DEMO_USER_ID, type: 'particulier',
    nom: 'Sophie & Thomas Renard', email: 'renard.famille@orange.fr',
    telephone: '06 55 66 77 88',
    adresse: '8 allée des Roses', ville: 'Versailles', code_postal: '78000', country: 'France',
    notes: 'Villa 220m². Après travaux. Très satisfaits.',
    date_creation: '2024-07-20T11:00:00Z', dernier_contact: '2026-08-28T10:00:00Z',
    first_name: 'Sophie', last_name: 'Renard', civility: 'Mme', is_canvassing: false,
    company_name: null, siren: null, siret: null, vat_number: null, legal_form: null, contact_name: null, service_address: null,
  },
  {
    id: 'client-004', user_id: DEMO_USER_ID, type: 'professionnel',
    nom: 'Restaurant Le Gourmet', email: 'direction@legourmet.fr',
    telephone: '01 48 12 34 56',
    adresse: '22 rue du Faubourg', ville: 'Neuilly-sur-Seine', code_postal: '92200', country: 'France',
    ...
    company_name: 'Restaurant Le Gourmet', siren: '45123456', siret: null, vat_number: 'FR45123456780', legal_form: 'EURL', contact_name: 'Chef de cuisine', service_address: null,
    first_name: null, last_name: null, civility: null, is_canvassing: false,
  },
  {
    id: 'client-005', user_id: DEMO_USER_ID, type: 'particulier',
    nom: 'Isabelle Moreau', email: 'isabelle.moreau@free.fr',
    telephone: '07 98 76 54 32',
    adresse: '3 impasse du Moulin', ville: 'Boulogne-Billancourt', code_postal: '92100', country: 'France',
    ...
    first_name: 'Isabelle', last_name: 'Moreau', civility: 'Mme', is_canvassing: false,
    company_name: null, siren: null, siret: null, vat_number: null, legal_form: null, contact_name: null, service_address: null,
  },
  {
    id: 'client-006', user_id: DEMO_USER_ID, type: 'professionnel',
    nom: 'SCI Les Pins Dorés', email: 'gestion@scilespins.fr',
    telephone: '01 39 45 67 89',
    adresse: '100 avenue du Général de Gaulle', ville: 'Saint-Cloud', code_postal: '92210', country: 'France',
    ...
    company_name: 'SCI Les Pins Dorés', siren: '56789012', siret: '56789012056789', vat_number: null, legal_form: 'SCI', contact_name: 'Syndic Gestion Pro', service_address: null,
    first_name: null, last_name: null, civility: null, is_canvassing: false,
  },
]
